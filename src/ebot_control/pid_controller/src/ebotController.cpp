...
ebotControllerNode::ebotControllerNode(ros::NodeHandle &n){
    ...
    sub_final_waypoints = n.subscribe("/global_path",1,&ebotControllerNode::lane_cb,this);   
...
void ebotControllerNode::lane_cb(const nav_msgs::Path::ConstPtr &recieved_curve) 
{   
